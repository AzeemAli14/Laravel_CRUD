    ...
    <body class="bg-gray-50">
        ...
        <section>
            <div class="min-h-screen bg-gray-100 flex justify-center items-center">
                <div class="grid gap-4 grid-cols-3 grid-rows-3 my-6">
                @foreach ($product as $products)
                    <div class="w-auto text-center justify-center align-center auto p-6 bg-white rounded-xl shadow-xl hover:shadow-2xl hover:scale-105 transition-all transform duration-500">
                        <img class="w-64 object-cover rounded-t-md" src="product/{{$products->image}}" alt="" />
                        <h1 class="text-2xl font-bold text-gray-700">{{$products->name}}</h1>
                        <p class="text-sm mt-2 text-gray-700">{{$products->description}}</p>
                        <div class="mt-3 space-x-4 flex p-1">
                            
                            <!-- <div class="mt-4 mx-auto mb-2 flex justify-between pl-4 pr-2"> -->
                                <div class="cursor-pointer mx-auto text-lg flex font-semibold py-2 px-6 text-green-100 hover:text-white bg-green-400 rounded-lg shadow-2xl hover:shadow-2xl transition duration-300">
